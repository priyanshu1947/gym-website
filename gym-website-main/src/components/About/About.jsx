        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 place-items-center">
          ...
          <div>
            <div className="space-y-5 sm:p-16 pb-6">
              ...
              "At Fitness Center, we're more than just a fitness center – we're a community committed to empowering individuals on their wellness journey. With a passionate team of experienced trainers and cutting-edge facilities, we inspire a healthier, stronger, and happier you."
              </p>
